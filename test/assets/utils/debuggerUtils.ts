...
export const setupDebuggerTestCases = (): SetupDebuggerTestCases[] => [
    ...
    // tc06 debugger enabled for limited models and operations
    {
        ...
        expectedNamespaces: [
            `testModel:${SpeedGooseDebuggerOperations.CACHE_PIPELINE}`, `testModel:${SpeedGooseDebuggerOperations.CACHE_QUERY}`,
            `secondaryTestModel:${SpeedGooseDebuggerOperations.CACHE_PIPELINE}`, `secondaryTestModel:${SpeedGooseDebuggerOperations.CACHE_QUERY}`,
            `cacheClear:${SpeedGooseDebuggerOperations.CACHE_PIPELINE}`, `cacheClear:${SpeedGooseDebuggerOperations.CACHE_QUERY}`
        ]
    },
