...
export const registerInternalQueueWorkers = (): void => {
    ...
    Container.set<Fastq.queueAsPromised<CacheSetQueuedTask>>(
        GlobalDiContainerRegistryNames.GLOBAL_CACHED_SETS_QUEUE_ACCESS,
        internalCachedSetsQueue)
}

export const getCachedSetsQueue = (): Fastq.queueAsPromised<CacheSetQueuedTask> =>
    Container.has(GlobalDiContainerRegistryNames.GLOBAL_CACHED_SETS_QUEUE_ACCESS) ?
        Container.get(GlobalDiContainerRegistryNames.GLOBAL_CACHED_SETS_QUEUE_ACCESS) : null
